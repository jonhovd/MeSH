...
: Wt::WContainerWidget()
{
	...
	auto appabout_anchor = std::make_unique<Wt::WAnchor>(appabout_link, Wt::WString::tr("AppAbout"));
    ...
    auto appquestion_anchor = std::make_unique<Wt::WAnchor>(appquestion_link, Wt::WString::tr("AppSendQuestion"));
    ...
    auto appstatistics_anchor = std::make_unique<Wt::WAnchor>(appstatistics_link, Wt::WString::tr("AppStatistics"));
