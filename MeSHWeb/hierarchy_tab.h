#ifndef _HIERARCHY_TAB_H_
#define _HIERARCHY_TAB_H_
...
class HierarchyTab : public Wt::WTemplate
{
public:
  HierarchyTab(const Wt::WString& text, MeSHApplication* mesh_application);
